...
def check_keydown_events(event, ai_settings, screen, ship, bullets, stats, aliens):
    ...
    if stats.game_active == False and event.key == pygame.K_p:
...
def check_fleet_edges(ai_settings, aliens):
    """Respone appropriately if any aliens have reached an edge."""
...
def update_aliens(ai_settings, stats, screen, ship, aliens, bullets):
    ...
    # Look for aliens getting to bottom of screen
